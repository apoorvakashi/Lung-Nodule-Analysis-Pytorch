...
class ClassificationTrainingApp:
    ...
    def initModel(self):
        model_cls = getattr(noduleAnalysis.model, self.cli_args.model)
        model = model_cls()
    ...
    def initTrainDl(self):
        ds_cls = getattr(combining_data.analysis_data, self.cli_args.dataset)
    ...
    def main(self):
        ...
        for epoch_ndx in range(1, self.cli_args.epochs + 1):
            ...
            if epoch_ndx == 1 or epoch_ndx % validation_cadence == 0:
                ...
                self.saveModel('mal', epoch_ndx, score == best_score)
    ...
    def computeBatchLoss(self, batch_ndx, batch_tup, batch_size, metrics_g,
        ...
        if augment:
            input_g = noduleAnalysis.model.augment3d(input_g)
    ...
    def logMetrics(
        ...
        threshold = torch.linspace(1, 0, steps=6)
